...
SECRET_KEY = 'django-insecure-your-default-secret-key-here'
...
INSTALLED_APPS = [
    'daphne', # Must be first for Daphne
...
HLS_MEDIA_ROOT = BASE_DIR / 'hls_media'
...
# Channel Layer settings (using in-memory for development)
CHANNEL_LAYERS = {
    "default": {
